#!/usr/bin/env python3
"""
Instagram Alter Ego Bot - Fixed version with proper imports
"""
...
# Fix import order to prevent namespace conflicts
# Import standard libraries first
import httpx  # Ensure httpx is imported before any other Client classes
...
class InstagramAlterEgoBot:
    ...
    def run(self, poll_interval: int = 30):
        """Main bot loop"""
        logger.info("Starting Instagram Alter Ego Bot polling loop...")
            ...
            try:
                ...
                for thread in threads:
                    ...
                    for message in reversed(messages):
                        ...
                        if msg_id in processed_messages or message.user_id == self.client.user_id:
                            continue
...
ALTER_EGO_PERSONALITY="You are my alter ego: a witty, adventurous version of myself."
""")
